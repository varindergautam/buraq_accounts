         ...
         <div class="panel panel-bd lobidrag">
             ...
             <div class="panel-body">
                 ...
                 <div class="form-group row">
                     ...
                     <label for="no_of_credit_days" class="col-sm-2 text-right col-form-label">Number of Credit Days:</label>
                     <div class="col-sm-4">
                         <div class="">
                             <input type="text" name="no_of_credit_days" class="form-control " id="no_of_credit_days" placeholder="No of credit days" value="<?php echo $customer->no_of_credit_days ?>">
                         </div>
                     </div>
