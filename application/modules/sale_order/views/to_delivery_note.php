            ...
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="quotation_no" id="quotation_no" class="form-control" placeholder="<?php echo "Quotation No." ?>" value="<?php echo $quot_main[0]['quotation_main_id']; ?>" readonly>
