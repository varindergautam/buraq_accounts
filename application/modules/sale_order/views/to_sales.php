...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open_multipart('sale_order/sale_order/save_to_sales', array('class' => 'form-vertical', 'id' => 'insert_quotation_to_invoice','name' => 'insert_quotation_to_invoice')) ?>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="pamount_by_method" class="form-control number pay "
                                            ...
                                            value="<?php echo $quot_main[0]['item_total_amount'];?>"  placeholder="0" readonly />
