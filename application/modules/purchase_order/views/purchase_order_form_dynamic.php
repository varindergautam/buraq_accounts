        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4><?php echo "Add Perchase Order" ?> </h4>
                </div>
            </div>
            ...
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" required name="qdate" class="form-control datepicker" id="qdate" value="<?php echo date('Y-m-d') ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" required name="expiry_date" class="form-control datepicker" id="expiry_date" value="<?php echo date('Y-m-d') ?>">
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        <td class="product_field">
                                            <input type="text" name="product_name" required onkeypress="invoice_productList(1);" class="form-control productSelection" placeholder='<?php echo display('product_name') ?>' id="product_name_1" tabindex="5">
                                        ...
                                        <td class="invoice_fields">
                                            <select class="form-control" required id="serial_no_1" onchange="invoice_product_batch(1)" name="serial_no[]" tabindex="7">
                                                <option></option>
                                            </select>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" required name="product_quantity[]" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" class="total_qntt_1 form-control text-right" id="total_qntt_1" placeholder="0.00" min="0" tabindex="8" value="1" />
                                        </td>
                                        <td>
                                            <input type="text" required name="product_rate[]" id="price_item_1" class="price_item1 price_item form-control text-right" tabindex="9" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" placeholder="0.00" min="0" />
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <a id="add_invoice_item" class="btn btn-info" name="add-invoice-item" onClick="addInputField_dynamic('addinvoiceItem');" tabindex="11">
                            ...
                            <table class="table table-bordered table-hover" id="serviceInvoice">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" onkeyup="serviceCAlculation(1);" onchange="serviceCAlculation(1);" id="service_discount" class="form-control totalServiceDicount text-right" name="service_discount" placeholder="0.00" />
