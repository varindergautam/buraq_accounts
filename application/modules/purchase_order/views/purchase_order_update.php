        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4><?php echo "Edit Purchase Order" ?></h4>
                </div>
            </div>

            <?php echo form_open_multipart('purchase_order/purchase_order/update_purchase_order', array('class' => 'form-vertical', 'id' => 'purchase_update')) ?>
                        ...
                        <tbody id="addPurchaseItem">
                            <?php foreach ($purchase_info as $purchases) { ?>
                                <tr>
                                    ...
                                    <!-- Discount start-->
                                    <td>
                                        <input type="text" name="discount_per[]" onkeyup="calculate_store(<?php echo $purchases['sl'] ?>);" onchange="calculate_store(<?php echo $purchases['sl'] ?>);" id="discount_<?php echo $purchases['sl'] ?>" class="form-control text-right" value="<?php echo $purchases['discount'] ?>" min="0" tabindex="11" placeholder="0.00" />
                                    ...
                                    <!-- VAT  start-->
                                    <td>
                                        <input type="text" name="vatpercent[]" onkeyup="calculate_store(<?php echo $purchases['sl'] ?>);" onchange="calculate_store(<?php echo $purchases['sl'] ?>);" id="vat_percent_<?php echo $purchases['sl'] ?>" value="<?php echo $purchases['vat_amnt_per'] ?>" class="form-control text-right" min="0" tabindex="13" placeholder="0.00" />
                        ...
                        <tfoot>
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="discount" class="text-right form-control total_discount_val discount" onkeyup="calculate_store(1)" name="discount" placeholder="0.00" value="<?php echo $total_discount; ?>" />
                                    </td>
                                    <td>
