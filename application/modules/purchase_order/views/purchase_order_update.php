        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4><?php echo "Update Purchase Order"; ?> </h4>
                </div>
            </div>
            <?php echo form_open('purchase_order/update_purchase_order', array('class' => 'form-vertical', 'id' => 'insert_quotation')) ?>
                                        ...
                                        ?>
                                            <tr>
                                                <td class="product_field">
                                                    <input type="text" required name="product_name" onkeypress="invoice_productList(<?php echo $sl; ?>);" class="form-control productSelection" placeholder='<?php echo display('product_name') ?>' value="<?php echo $item['product_name'] . ' (' . $item['product_model'] . ')'; ?>" id="product_name_<?php echo $sl; ?>" tabindex="5">
                                                ...
                                                <!--                                        </td>-->
                                                <!--                                        <td>-->
                                                <input type="hidden" name="available_quantity[]" class="form-control text-right available_quantity_<?php echo $sl; ?>" value="<?php echo $available_quantity; ?>" readonly="" />
                                                <!--                                        </td>-->
                                                <td>
                                                ...
                                                <td class="invoice_fields">
                                                    <input type="text" required name="product_rate[]" id="price_item_<?php echo $sl; ?>" class="price_item<?php echo $sl; ?> price_item form-control text-right" tabindex="9" onkeyup="quantity_calculate(<?php echo $sl; ?>); validateMinValue(this);" onchange="quantity_calculate(<?php echo $sl; ?>); validateMinValue(this);" value="<?php echo $item['rate']; ?>" placeholder="0.00" min="<?php echo $item['supplier_rate']; ?>" />
                                                ...
                                                <td>
                                                    <input type="text" name="discountvalue[]" id="discount_value_<?php echo $sl; ?>" class="form-control text-right" min="0" tabindex="18" placeholder="0.00" value="<?php echo $item['discount']; ?>" readonly />
                                                </td>

                                                <!-- VAT  -->
                                                <td>
                                                    <input type="text" name="vatpercent[]" onkeyup="quantity_calculate(<?php echo $sl; ?>);" onchange="quantity_calculate(<?php echo $sl; ?>);" id="vat_percent_<?php echo $sl; ?>" value="<?php echo $item['vat_per']; ?>" class="form-control text-right" min="0" tabindex="19" placeholder="0.00" />

                                                </td>
                                                <td>
                                                    <input type="text" name="vatvalue[]" id="vat_value_<?php echo $sl; ?>" class="form-control text-right total_vatamnt" min="0" tabindex="20" value="<?php echo $item['vat_amnt']; ?>" placeholder="0.00" readonly />
                                                </td>
                                                <!-- VAT end -->
                                ...
                                <tbody id="addservicedata">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="service_discountvalue[]" id="service_discount_value_1" class="form-control text-right" min="0" tabindex="18" placeholder="0.00" value="<?php echo $service['discount_amount']; ?>" readonly />
                                                </td>
