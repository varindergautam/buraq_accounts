                                ...
                                <table class="table table-bordered table-hover" id="normalinvoice">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="invoice_fields">
                                                    <select class="form-control" required id="serial_no_<?php echo $sl; ?>" name="serial_no[]" tabindex="7">
                                                ...
                                                <td class="invoice_fields">
                                                    <input type="text" required name="product_rate[]" id="price_item_<?php echo $sl; ?>" class="price_item<?php echo $sl; ?> price_item form-control text-right" tabindex="9" onkeyup="quantity_calculate(<?php echo $sl; ?>);" onchange="quantity_calculate(<?php echo $sl; ?>);" value="<?php echo $item['rate']; ?>" placeholder="0.00" min="0" />
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><a id="add_invoice_item" class="btn btn-info" name="add-invoice-item" onClick="addInputField_dynamic('addinvoiceItem');" tabindex="11"><i class="fa fa-plus"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right" colspan="9">
                                        ...
                                        <input type="hidden" id="total_vat_amnt" name="total_vat_amnt" value="<?php echo $quot_main[0]['item_total_vat']; ?>" />
                                        <tr>
                            ...
                            <table class="table table-bordered table-hover" id="serviceInvoice">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" id="add_service_item" class="btn btn-info" name="add-invoice-item" onClick="addService_dynamic('addservicedata');"><i class="fa fa-plus"></i></button></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <input type="hidden" id="service_total_vat_amnt" name="service_total_vat_amnt" value="<?php echo $quot_main[0]['service_total_vat']; ?>" />
                                    <tr>
