                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="supplier_id" id="supplier_id1" class="form-control " required="" tabindex="1" onchange="handleSelectChange(this)">
                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td> <button type="button" id="add_invoice_item" class="btn btn-info" name="add-invoice-item" onClick="addPurchaseOrderField1('addPurchaseItem'); addAnotherFunction();" tabindex="9"><i class="fa fa-plus"></i></button>
                        ...
                        <div id="adddiscount" class="display-none">
                            <div class="row no-gutters">
                                <div class="form-group col-md-6">
                                    ...
                                    echo form_dropdown('multipaytype[]', $all_pmethod, (isset($card_type) ? $card_type : null), 'onchange="check_creditsale()" required class="card_typesl postform resizeselect form-control" id="cardTypeSelect"');
                                    ?>
