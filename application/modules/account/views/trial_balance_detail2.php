         ...
         <div id="printArea">
            <table width="99%" align="center" class="datatable table table-striped table-bordered table-hover general_ledger_report_tble">
               ...
               <tr>
                    ...
                    <td  align="right"><?php echo $settings->currency. ' '. number_format(0,2,'.',','); ?></td>
                    <td  align="right"><?php echo $settings->currency. ' '. number_format(0,2,'.',','); ?></td>
                    <td  align="right"><strong><?php echo $settings->currency. ' '. number_format($prebalance,2,'.',','); ?></strong></td>
                </tr>
                <?php  
                ...
                <tr>
                    ...
                    <td align="right"><?php echo $settings->currency. ' '. number_format($data->Debit,2,'.',','); ?></td>
                    <td align="right"><?php echo $settings->currency. ' '. number_format($data->Credit,2,'.',','); ?></td>  
...
;                     } ?>
                      <td align="right"><?php echo $settings->currency. ' '.  number_format($CurBalance,2,'.',','); ?></td>                       
               </tr>
              <?php } ?>
          <tfoot>
                <tr class="table_data"> 
                    ...
                    <td align="right"><strong><?php echo  $settings->currency. ' '.number_format($TotalDebit,2,'.',','); ?></strong></td>
                    <td align="right"><strong><?php echo $settings->currency. ' '. number_format($TotalCredit,2,'.',','); ?></strong></td>
                    <td align="right"><strong><?php echo $settings->currency. ' '. number_format($CurBalance,2,'.',','); ?></strong></td>
                </tr>
           </tfoot>               
           </tbody>
                <h4 style="margin-left: 10px; margin-top: 15px;float: right;">
                    <?php echo display('opening_balance')?> : <?php echo $settings->currency. ' '. number_format($prebalance,2,'.',','); ?>
                    <br /> <?php echo display('closing_balance')?> : <?php echo $settings->currency. ' '. number_format($CurBalance,2,'.',','); ?>
                </h4>
       </table>
    </div>
