    ...
    <ul class="sidebar-menu">
        ...
        <?php if ($this->permission1->method('new_invoice', 'create')->access() || $this->permission1->method('manage_invoice', 'read')->access() || $this->permission1->method('pos_invoice', 'create')->access() || $this->permission1->method('gui_pos', 'create')->access() || $this->permission1->method('terms_list', 'read')->access()  || $this->permission1->method('terms_add', 'read')->access()) { ?>
            <li class="treeview <?php
                                if ($this->uri->segment('1') == ("add_invoice") || $this->uri->segment('1') == ("invoice_list") || $this->uri->segment('1') == ("pos_invoice") || $this->uri->segment('1') == ("gui_pos") || $this->uri->segment('1') == ("invoice_details") || $this->uri->segment('1') == ("invoice_pad_print") || $this->uri->segment('1') == ("pos_print") || $this->uri->segment('1') == ("invoice_edit") || $this->uri->segment('1') == ("terms_list")  || $this->uri->segment('1') == ("terms_add") || $this->uri->segment('1') == ("add_quotation") || $this->uri->segment('1') == ("manage_quotation") || $this->uri->segment('1') == ("quotation_to_sales") || $this->uri->segment('1') == ("manage_delivery") || $this->uri->segment('1') == ("manage_sale_order") || $this->uri->segment('1') == ("performa_form") || $this->uri->segment('1') == ("manage_performa") || $this->uri->segment('1') == ("performa")) {
                                    echo "active";
                                } else {
                                    echo " ";
                                }
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->permission1->method('terms_list', 'create')->access()) { ?>
                        <li class="treeview <?php
                                            ...
                                            ?>">
                            <a href="<?php echo base_url('terms_list') ?>"><?php echo display('terms_list') ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('terms_add', 'create')->access()) { ?>
                        <li class="treeview <?php
                                            ...
                                            ?>">
                            <a href="<?php echo base_url('terms_add') ?>"><?php echo display('terms_add') ?></a>
                        </li>
                    <?php } ?>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php if ($this->permission1->method('manage_quotation', 'read')->access()) { ?>
                                    <li class="treeview <?php if ($this->uri->segment('1') == ("manage_quotation")) {
                                                            ...
                                                            echo " ";
                                                        } ?>"><a href="<?php echo base_url('manage_quotation') ?>"><?php echo display('manage_quotation') ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </li>
                    ...
                    <?php if ($this->permission1->method('manage_delivery', 'read')->access()) { ?>
                        <li class="treeview <?php
                                            if ($this->uri->segment('1') == ("add_delivery") || $this->uri->segment('1') == ("manage_delivery") || $this->uri->segment('1') == ("quotation_to_sales")) {
                                                echo "active";
                                            } else {
                                                echo " ";
                                            }
                                            ?>">
                            <a href="#">
                                <span><?php echo display('delivery_note') ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <?php if ($this->permission1->method('manage_delivery', 'read')->access()) { ?>
                                    <li class="treeview <?php if ($this->uri->segment('1') == ("manage_delivery")) {
                                        ...
                                        <a href="<?php echo base_url('manage_delivery') ?>"><?php echo 'Manage Delivery Note'; ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </li>
                    ...
                    <?php if ($this->permission1->method('add_sale_order', 'create')->access() || $this->permission1->method('manage_sale_order', 'read')->access()) { ?>
                        <li class="treeview <?php
                                            if ($this->uri->segment('1') == ("add_sale_order") || $this->uri->segment('1') == ("manage_sale_order") || $this->uri->segment('1') == ("sale_order_to_sales")) {
                                                echo "active";
                                            } else {
                                                echo " ";
                                            }
                            ...
                            <ul class="treeview-menu">
                                <?php if ($this->permission1->method('manage_sale_order', 'read')->access()) { ?>
                                    <li class="treeview <?php if ($this->uri->segment('1') == ("manage_sale_order")) {
                                                            ...
                                                            echo " ";
                                                        } ?>"><a href="<?php echo base_url('manage_sale_order') ?>"><?php echo "Manage Sale Order" ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </li>
                    ...
                    <?php if ($this->permission1->method('performa_form', 'create')->access() || $this->permission1->method('manage_performa', 'read')->access()) { ?>
                        <li class="treeview <?php
                                            ...
                                            if ($this->uri->segment('2') == ("performa_form") || $this->uri->segment('1') == ("manage_performa") || $this->uri->segment('1') == ("performa")) {
                                                echo "active";
                                            } else {
                                                echo " ";
                                            }
                                            ?>">
                            <a href="#">
                                <span><?php echo "Performa invoice" ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php if ($this->permission1->method('manage_performa', 'read')->access()) { ?>
                                    <li class="treeview <?php if ($this->uri->segment('1') == ("manage_performa")) {
                                                            ...
                                                            echo " ";
                                                        } ?>"><a href="<?php echo base_url('manage_performa') ?>"><?php echo "Manage Performa Invoice" ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </li>
        ...
        <?php if ($this->permission1->method('add_purchase', 'create')->access() || $this->permission1->method('manage_purchase', 'read')->access()) { ?>
            <li class="treeview <?php
                                if ($this->uri->segment('1') == ("add_purchase") || $this->uri->segment('1') == ("purchase_edit") || $this->uri->segment('1') == ("purchase_list") || $this->uri->segment('1') == ("purchase_details") || $this->uri->segment('2') == ("purchase_order_form") || $this->uri->segment('1') == ("manage_purchase_order")) {
                                    echo "active";
                                } else {
                                    echo " ";
                                }
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->permission1->method('manage_purchase_order', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("manage_purchase_order")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('manage_purchase_order') ?>"><?php echo "Manage purchase order" ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </li>
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->permission1->method('debit_voucher', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("debit_voucher")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('debit_voucher') ?>"><?php echo display('debit_voucher'); ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('credit_voucher', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("credit_voucher")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('credit_voucher') ?>"><?php echo display('credit_voucher'); ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('contra_voucher', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("contra_voucher")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('contra_voucher') ?>"><?php echo display('contra_voucher'); ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('journal_voucher', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("journal_voucher")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('journal_voucher') ?>"><?php echo display('journal_voucher'); ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('bank_reconciliation', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("bank_reconciliation")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('bank_reconciliation') ?>"><?php echo display('bank_reconciliation'); ?></a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($this->permission1->method('supplier_payment', 'create')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("supplier_payment")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('supplier_payment') ?>"><?php echo display('supplier_payment'); ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('customer_receive', 'create')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("customer_receive")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('customer_receive') ?>"><?php echo display('customer_receive'); ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('service_payment', 'create')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("service_payment")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('service_payment') ?>"><?php echo display('service_payment'); ?></a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($this->permission1->method('cash_adjustment', 'create')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("cash_adjustment")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('cash_adjustment') ?>"><?php echo display('cash_adjustment'); ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('aprove_v', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("aprove_v")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('aprove_v') ?>"><?php echo display('voucher_approval'); ?></a>
                        </li>
                    <?php } ?>
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->permission1->method('todays_customer_receipt', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("todays_customer_received")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('todays_customer_received') ?>"><?php echo display('todays_customer_receipt') ?></a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($this->permission1->method('due_report', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("invoice_wise_due_report")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('invoice_wise_due_report') ?>"><?php echo 'Customer Due Report'; ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('shipping_cost_report', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("shipping_cost_report")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('shipping_cost_report') ?>"><?php echo display('shipping_cost_report'); ?></a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($this->permission1->method('sales_report_product_wise', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("product_wise_sales_report")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('product_wise_sales_report') ?>"><?php echo display('sales_report_product_wise') ?></a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($this->permission1->method('supplier_return', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("supplier_returns")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('supplier_returns') ?>"><?php echo display('supplier_return') ?></a>
                        </li>
                    <?php } ?>
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->permission1->method('return_list', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("invoice_return_list")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('invoice_return_list') ?>"><?php echo display('stock_return_list') ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('supplier_return_list', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("supplier_return_list")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('supplier_return_list') ?>"><?php echo display('supplier_return_list') ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($this->permission1->method('wastage_return_list', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("wastage_return_list")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('wastage_return_list') ?>"><?php echo display('wastage_return_list') ?></a>
                        </li>
                    <?php } ?>
