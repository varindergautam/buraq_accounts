    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("invoice_wise_due_report")){
                        ...
                        href="<?php echo base_url('invoice_wise_due_report') ?>"><?php echo 'Customer Due Report'; ?></a>
                </li>
                <?php } ?>
        ...
        <li class="treeview <?php
            ...
            <a href="#">
                ...
                ?>">
                    <a href="#">
                        <i class="fa fa-book"></i><span><?php echo display('delivery_note') ?></span>
                        <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
                    </a>
        ...
        <li class="treeview <?php
            ...
            ?>">
            <a href="#">
                <i class="fa fa-book"></i><span><?php echo "Sale Order" ?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
                <ul class="treeview-menu">
                        ...
                        <li class="treeview <?php if ($this->uri->segment('1') == ("manage_sale_order")){
                                ...
                                href="<?php echo base_url('manage_sale_order') ?>"><?php echo "Manage Sale Order" ?></a>
                        </li>
                        <?php } ?>
                    </ul>
                </li>
