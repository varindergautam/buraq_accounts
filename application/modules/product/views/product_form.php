            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="serial_no"
                                   class="col-sm-4 col-form-label">Minimum sale price </label>
                            <div class="col-sm-8">
                                <input type="text" tabindex="" class="form-control " id="min_sale_price" name="min_sale_price"
                                       placeholder="Minimum sale price"
                                       value="<?php echo $product->min_sale_price?>" />
                            </div>
                        </div>
                    </div>
                    <?php 
