        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4><?php echo 'Update Delivery Note'; ?> </h4>
                </div>
            </div>
            <?php echo form_open('delivery/delivery/update_quotation', array('class' => 'form-vertical', 'id' => 'insert_quotation')) ?>
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="quotation_no" class="col-sm-4 col-form-label"><?php echo 'Delivery Note no'; ?>
                        </label>
                        <div class="col-sm-8">
                            <input type="text" name="quotation_no" id="quotation_no" class="form-control"
                                placeholder="<?php echo 'Delivery Note no'; ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="qdate" class="col-sm-4 col-form-label"><?php echo 'Delivery Note Date'; ?>
                        </label>
                        <div class="col-sm-8">
