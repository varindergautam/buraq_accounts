...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open_multipart('delivery/delivery/add_quotation_to_invoice', array('class' => 'form-vertical', 'id' => 'insert_quotation_to_invoice', 'name' => 'insert_quotation_to_invoice')) ?>
                                    ...
                                    <tbody id="addinvoiceItem">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="" id="" class="form-control text-right unit_<?php echo $sl; ?> valid" value="<?php echo $item['unit']; ?>" readonly="" aria-invalid="false" type="text" <?php echo $readonly; ?>>
                                                </td>
                                                <td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <input type="hidden" id="txfieldnum" value="<?php echo $taxnumber; ?>" <?php echo $readonly; ?>>
                                            </td>
                                            <?php if ($disabled != 'disabled') { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <input type="text" id="paidAmount" onkeyup="invoice_paidamount();" class="form-control text-right" name="paid_amount" placeholder="0.00" tabindex="22" value="<?php echo $quot_main[0]['item_total_amount']; ?>" data-listener-added_fa723d9e="true" data-listener-added_4789e008="true">
                                            </td>
                                        </tr>
