                        ...
                        <div class="fl-left">
                            ...
                            <div class="col-xs-4 text-left ">
                                ...
                                <?php if ($customer_info[0]['customer_name']) { ?>
                                    ...
                                    <abbr>
                                    <span class="font-bold"><?php echo 'Delivery Date'; ?>: </span>
                                        ...
                                        <span class="font-bold"><?php echo 'Delivery Note No'; ?>: </span>
                    ...
                    if (!empty($quot_product[0]['product_name'])) {
                        ...
                        <table class="table table-striped print-font-size">
                            <caption class="text-center">
                                <h2 class="title-text"><?php echo 'Delivery Note'; ?></h2>
                            </caption>
                            <thead>
                                <tr>
...
<!--                                    </td>-->
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive m-b-20">
                            ...
                            <div class="row ">
                                <div class="desc-div">
                                    <strong><?php echo 'Delivery Note Description'; ?> :</strong>
