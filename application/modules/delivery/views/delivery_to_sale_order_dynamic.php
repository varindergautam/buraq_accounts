...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open_multipart('/delivery/add_delivery_to_sale_order', array('class' => 'form-vertical', 'id' => 'insert_quotation_to_invoice', 'name' => 'insert_quotation_to_invoice')) ?>
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="quotation_no" class="col-sm-4 col-form-label"><?php echo "Sale Order No." ?>
                        </label>
                        <div class="col-sm-8">
                            <input type="text" name="quotation_no" id="quotation_no" class="form-control" placeholder="Sale Order No." value="<?php echo $quot_main[0]['quotation_main_id']; ?>" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="qdate" class="col-sm-4 col-form-label"><?php echo "Sale Order Date" ?>
                        </label>
                        <div class="col-sm-8">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input id="total_tax<?php echo $x; ?>_<?php echo $sl; ?>" class="totalTax total_tax<?php echo $x; ?>_<?php echo $sl; ?>" type="hidden" value="<?php echo $item[$tfield]; ?>">
                ...
                <hr>
                <div>
                    <button type="button" class="btn btn-primary" id="service_quotation_div"><?php echo "Add Service Sale Order" ?></button>
                </div>
                ...
                <div class="form-group row text-right">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="submit" id="add_invoice" class="btn btn-success btn-large" name="add-quotation" value="<?php echo 'Add To Sale Order'; ?>" />
