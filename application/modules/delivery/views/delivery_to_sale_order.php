...
<?php
if ($quot_main[0]['status'] == 2 ||  $quot_main[0]['sale_order_status'] == 2) {
    $readonly = 'readonly';
    $disabled = 'disabled';
} else {
    $readonly = '';
            ...
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="quotation_no" id="quotation_no" class="form-control" placeholder="<?php echo "Sale Order No." ?>" value="<?php echo $quot_main[0]['quot_no']; ?>" readonly>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" value="<?php echo $discount_type; ?>" name="discount_type" id="discount_type_<?php echo $sl; ?>" <?php echo $readonly; ?>>
                            ...
                            <div id="adddiscount" class="display-none">
                                <div class="row no-gutters">
                                    <div class="form-group col-md-6">
                                        ...
                                        echo form_dropdown('multipaytype[]', $all_pmethod, (!empty($card_type) ? $card_type : null), 'class="card_typesl postform resizeselect required form-control "  id="cardTypeSelect"') ?>
