        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4><?php echo 'Add Delivery Note'; ?> </h4>
                </div>
            </div>
            <?php echo form_open('delivery/delivery/bdtask_insert_quotation', array('class' => 'form-vertical', 'id' => 'insert_quotation')) ?>
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="qdate" class="col-sm-4 col-form-label"><?php echo 'Delivery Note Date'; ?><i
                                class="text-danger">*</i> </label>
                        <div class="col-sm-8">
...
<!--                                        </td>-->
                ...
                <div>
                    <button type="button" class="btn btn-primary"
                        id="service_quotation_div"><?php echo 'Add Service Delivery'; ?></button>
                </div>
