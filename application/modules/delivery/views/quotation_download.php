...
<div class="printableArea" id="printableArea">
    ...
    <div class="firts_section" style="">
        ...
        <div class="first_section_right" style="width: 28%; display: inline-block;">
            <h1 style="margin-top:0px;margin-bottom: 0px;"><?php echo 'Delivery Note'; ?></h1>
            <address>
                ...
                <abbr><b><?php echo 'Delivery No'; ?>:</b></abbr> <?php echo $quot_main[0]['quot_no'] ?><br>
            </address>
        </div>
    </div>
    <div class="">
            ...
            <table class="table table-striped">
                <caption class="text-center">
                    <h2 style="border:1px;background-color: #DDE4EB;color:#000">
                        <?php echo display('item').'Delivery Note'?> </h2>
                </caption>
                <thead>
                    <tr>
