...
$route['add_delivery']            = "delivery/delivery/bdtask_quotation_form";
$route['manage_delivery']         = "delivery/delivery/manage_quotation";
$route['delivery_details/(:any)']= "delivery/delivery/quotation_details_data/$1";
$route['edit_delivery/(:any)']   = "delivery/delivery/quotation_edit/$1";
$route['delivery_to_sales/(:any)']= "delivery/delivery/quotation_to_sales/$1";