                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="">
                                            <input type="text" name="no_of_credit_days" class="form-control " id="no_of_credit_days" placeholder="No of credit days" value="<?php echo $supplier->no_of_credit_days ?>">
                                        </div>
                                    </div>
