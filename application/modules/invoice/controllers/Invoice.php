...
class Invoice extends MX_Controller
{
    ...
    public function gui_pos_invoice()
    {
        ...
        if (!empty($product_details)) {
            ...
            $tr .= "<tr id=\"row_" . $product_details->product_id . "\">
                        ...
                        <td style=\"width:85px\">
                            <input type=\"text\" name=\"product_rate[]\" onkeyup=\"quantity_calculate('" . $product_details->product_id . "'); validateMinValue(this);\" onchange=\"quantity_calculate('" . $product_details->product_id . "'); validateMinValue(this);\" value='" . $product_details->price . "' id=\"price_item_" . $product_details->product_id . "\" class=\"price_item1 form-control text-right\" required placeholder=\"0.00\" min=\"0\"/>
                            <span id=\"minValueMsg" . $product_details->product_id . "\" style=\"display: none; color: red;\"></span>
                            <input type=\"hidden\" name=\"min_sale_price[]\" id=\"min_sale_price" . $product_details->product_id . "\" onkeyup=\"quantity_calculate('" . $product_details->supplier_price . "');\"  class=\"price_item1 form-control text-right\" required placeholder=\"0.00\" min=\"0\" value = \"$product_details->supplier_price\" />         
                        </td>
                        <td class=\"\">
    ...
    public function to_delivery($quot_id = null)
    {
        $data['type'] = isset($_GET['type']) ? $_GET['type'] : NULL;
        $vat_tax_info   = vatTaxSetting();
        $data['quot_main']       = $this->invoice_model->single_invoice($quot_id);
    ...
    public function add_to_delivery()
    {
