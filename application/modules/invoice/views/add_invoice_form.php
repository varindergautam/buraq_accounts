                            ...
                            <tr>
                                ...
                                <td class="invoice_fields">
                                    <input type="text" name="product_rate[]" id="price_item_1"
                                           ...
                                           onkeyup="bdtask_invoice_quantity_calculate(1); validateMinValue(this);"
                                           onchange="bdtask_invoice_quantity_calculate(1); validateMinValue(this);"
                                           placeholder="0.00" />
                                    <span id="minValueMsg_1" style="display: none; color: red;"></span>
                                    <input type="hidden" name="min_sale_price[]" id="min_sale_price_1" value="<?php echo isset($product_info['min_sale_price']) ? $product_info['min_sale_price'] : '0'; ?>">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><a href="javascript:void(0)" id="add_invoice_item" class="btn btn-info"
                                        name="add-invoice-item" onClick="addInputField_invoice('addinvoiceItem'); addAnotherFunction();"
...
function addAnotherFunction() {
    var table = document.getElementById("normalinvoice"); // Make sure to enclose the element ID in quotes

    var selectInputs = table.querySelectorAll('select[name="serial_no[]"]');
    for (var i = 0; i < selectInputs.length; i++) {
        var select = selectInputs[i];

        // Remove the "required" attribute from the select element
...
function validateMinValue(input) {
    ...
    timeoutReference = setTimeout(function() {
        ...
        var minValue = parseFloat(document.getElementById('min_sale_price_' + number).value);
