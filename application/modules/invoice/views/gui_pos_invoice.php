...
function validateMinValue(input) {
    ...
    timeoutReference = setTimeout(function() {
        ...
        var minValue = parseFloat(document.getElementById('min_sale_price' + number).value);

        console.log('Input value:', value);

        console.log('Supplier price value:', minValue);

        var errorElement = document.getElementById('minValueMsg' + number);

        if (isNaN(value) || value < minValue) {
            errorElement.innerHTML = 'Minimun price must be' + minValue;
