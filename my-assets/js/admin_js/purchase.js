  ...
  var  tab14 = 0;
    ...
    if (count == limits)  {
       ...
       newdiv = document.createElement("tr");
        ...
        newdiv.innerHTML ='<td class="span3 supplier"><input type="text" name="product_name" required="" class="form-control product_name productSelection" onkeypress="product_pur_or_list('+ count +
        ');" placeholder="Product Name" id="product_name_'+ count +'" tabindex="'+tab1+'" > <input type="hidden" class="autocomplete_hidden_value product_id_'+ count +
        ...
        '" class="form-control text-right stock_ctn_'+ count +'" placeholder="0.00" readonly/> </td><td class="wt"><input type="text" name="expiry_date[]"   id="expiry_date_'+ count +
        '" class="form-control datepicker" placeholder="Expiry Date"/>  </td><td class="text-right"><input type="text" name="product_quantity[]" tabindex="'+tab2+
        ...
        '" /><input type="hidden" value="1" name="discount_type"id="discount_type_'+ count +'"></td><td class="test"><input type="text" name="discountvalue[]" onkeyup="calculate_store('+ count +
        ...
        '" value="0.00" readonly="readonly" /> <input type="hidden" id="total_discount_'+ count +'" class="" /><input type="hidden" id="all_discount_'+ count +'" class="total_discount dppr" name="discount_amount[]" /></td><td> <button  class="btn btn-danger text-right red" type="button"  onclick="deleteRow(this)" tabindex="8"><i class="fa fa-close"></i></button></td>';
